...
import { IonContent, IonHeader, IonTitle, IonToolbar,IonButton,IonAvatar,IonButtons, IonInput} from '@ionic/angular/standalone';
...
@Component({
  ...
  standalone: true,
  imports: [IonContent, IonHeader, IonTitle, IonToolbar, CommonModule, FormsModule,IonButton,IonAvatar,IonButtons,RouterModule, IonInput]
})
export class UsuarioPage implements OnInit {
  titulo:string = "User title User Info";
  srcImagenUser:string = "https://cdn-icons-png.flaticon.com/512/3135/3135768.png";
